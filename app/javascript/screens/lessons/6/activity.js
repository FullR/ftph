...
var Lesson6Activity = React.createClass({
    ...
    getAdditionalSounds: function() {
        return {
            "sounded-word": `lessons/lesson-6/sounded-words/${this.props.phonics.join("_")}`,
    ...
    render: function() {
        ...
        var choices    = this.props.choices;
        var phonics    = this.props.phonics;
                ...
                renderFeedback={(activity) => {
                    ...
                    render(
                        <Feedback
                            ...
                            sounds={{
                                "sounded-word":  `lessons/lesson-6/sounded-words/${phonics.join("_")}`,
